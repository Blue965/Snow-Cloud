...
export function AuthForm({ mode }: { mode: "sign-in" | "sign-up" }) {
  ...
  return (
    <main className="min-h-svh bg-background flex items-center justify-center px-4 py-16 relative overflow-hidden">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-0 h-[500px] w-[500px] -translate-x-1/2 rounded-full bg-primary/15 blur-[120px]"
      />
      ...
      <div className="relative w-full max-w-sm">
        <Link href="/" className="mb-8 flex items-center justify-center gap-2">
          ...
          <span className="font-sans text-lg font-semibold tracking-tight text-foreground">Snow Cloud</span>
        </Link>
        ...
        <div className="rounded-2xl border border-border bg-card/60 p-6 backdrop-blur-xl">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              {isSignUp ? "Hébergez votre premier bot en quelques secondes" : "Connectez-vous pour accéder à votre dashboard"}
            </p>
          </div>
          ...
          >
            ...
            {googleLoading ? "Veuillez patienter..." : "Continuer avec Google"}
          </Button>
